use lh_project;
select * from luxury_house_data;
describe luxury_house_data;
/*1st question*/
use lh_project;
SELECT 
    Micro_Market,
...
SELECT 
    Amenity_Score,
    COUNT(Property_ID) * 100.0 / (SELECT COUNT(*) FROM Luxury_house_data) AS Booking_Success_Rate,
